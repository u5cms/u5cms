...
jQuery.fn.removeHighlight = function() {
  return this.find("span.hitshilite").each(function() {
...
function openshowblocks() {
e=document.getElementsByClassName('showblockdivinner');
for(i=0;i<e.length;i++) {
if(e[i].innerHTML.indexOf('<span class="hitshilite">')>-1)if(e[i].previousSibling)e[i].previousSibling.click();
}
e=document.getElementsByClassName('showblock2divinner');
for(i=0;i<e.length;i++) {
if(e[i].innerHTML.indexOf('<span class="hitshilite">')>-1)if(e[i].previousSibling)e[i].previousSibling.click();
}
jQuery('html, body').animate({
    scrollTop: ($(".hitshilite:visible").offset().top)-200
}, 700);
}
setTimeout("openshowblocks()",1111);