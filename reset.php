...
echo('<h1>'.def($wait_d,$wait_e,$wait_f).' '.(file_get_contents('fileversions/lastreset.txt')-time()+$waitsecondsbetweenpasswordresets).'&#8243;</h1><script>setTimeout("location.href=location.href",1000)</script>');
exit;	
}
?>
