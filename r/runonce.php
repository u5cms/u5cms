...
$sql_a="UPDATE resources SET content_1=REPLACE(content_1,'THE ABOVE E-MAIL ADDRESS MUST HAVE THE SAME DOMAIN AS THIS WEBSITE AND IT MUST EXIST!!!','IT IS EXTREMELY IMPORTANT THAT YOU READ https://yuba.ch/mail REGARDING THE SENDING OF FORM CONTENT BY EMAIL AND THE SENDER ADDRESS USED FOR THIS!!!');";
$result_a=mysql_query($sql_a);
if ($result_a==false) echo 'SQL_a-Query did not work!<p>'.mysql_error().'<p><font color=red>'.$sql_a.'</font><p>';

$sql_a="UPDATE resources SET content_2=REPLACE(content_2,'THE ABOVE E-MAIL ADDRESS MUST HAVE THE SAME DOMAIN AS THIS WEBSITE AND IT MUST EXIST!!!','IT IS EXTREMELY IMPORTANT THAT YOU READ https://yuba.ch/mail REGARDING THE SENDING OF FORM CONTENT BY EMAIL AND THE SENDER ADDRESS USED FOR THIS!!!');";
$result_a=mysql_query($sql_a);
if ($result_a==false) echo 'SQL_a-Query did not work!<p>'.mysql_error().'<p><font color=red>'.$sql_a.'</font><p>';

$sql_a="UPDATE resources SET content_3=REPLACE(content_3,'THE ABOVE E-MAIL ADDRESS MUST HAVE THE SAME DOMAIN AS THIS WEBSITE AND IT MUST EXIST!!!','IT IS EXTREMELY IMPORTANT THAT YOU READ https://yuba.ch/mail REGARDING THE SENDING OF FORM CONTENT BY EMAIL AND THE SENDER ADDRESS USED FOR THIS!!!');";
$result_a=mysql_query($sql_a);
if ($result_a==false) echo 'SQL_a-Query did not work!<p>'.mysql_error().'<p><font color=red>'.$sql_a.'</font><p>';

$sql_a="UPDATE resources SET content_4=REPLACE(content_4,'THE ABOVE E-MAIL ADDRESS MUST HAVE THE SAME DOMAIN AS THIS WEBSITE AND IT MUST EXIST!!!','IT IS EXTREMELY IMPORTANT THAT YOU READ https://yuba.ch/mail REGARDING THE SENDING OF FORM CONTENT BY EMAIL AND THE SENDER ADDRESS USED FOR THIS!!!');";
$result_a=mysql_query($sql_a);
if ($result_a==false) echo 'SQL_a-Query did not work!<p>'.mysql_error().'<p><font color=red>'.$sql_a.'</font><p>';

$sql_a="UPDATE resources SET content_5=REPLACE(content_5,'THE ABOVE E-MAIL ADDRESS MUST HAVE THE SAME DOMAIN AS THIS WEBSITE AND IT MUST EXIST!!!','IT IS EXTREMELY IMPORTANT THAT YOU READ https://yuba.ch/mail REGARDING THE SENDING OF FORM CONTENT BY EMAIL AND THE SENDER ADDRESS USED FOR THIS!!!');";
$result_a=mysql_query($sql_a);
if ($result_a==false) echo 'SQL_a-Query did not work!<p>'.mysql_error().'<p><font color=red>'.$sql_a.'</font><p>';
