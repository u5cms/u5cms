...
?>
<script>
document.u5form.action='delformsave.php?a=<?php echo $_GET['a']?>&id=<?php echo $_GET['id']?>&ti=<?php echo $row_a['time']?>&hu=<?php echo rawurlencode($row_a['humantime'])?>&st=<?php echo $row_a['status']?>&n=<?php echo $_GET['n']?>&l=<?php echo $_GET['l']?>';
</script>
...
<script>
document.getElementById('body').innerHTML+='<button type="button" style="cursor:pointer;position:fixed;z-index:999999;top:0px;left:0px;width:100%;background:red;color:white;padding:10px;font-size:33px" onclick="document.u5form.submit()">delete</button>';
</script>
