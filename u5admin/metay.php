...
<body>
<form onsubmit="cchanges=0;document.querySelectorAll('.asterisk').forEach(e=>e.classList.add('blink_me'));" action="meta2.php?typ=<?php echo $_GET['typ']?>&uri=metay.php" method="post" name="form1" id="form1">
  <p>
    <?php 
