...
<h1 style="margin-bottom:7px">Import</h1>
Copy and paste the data to import from Excel into the textarea below. <small>Delimiter MUST be Tab, the opt. Enclosure character is &quot;. The 1st row MUST ALWAYS contain the Headings, not data. System status column MUST be removed.</small>
<form name="form" method="post" action="import2.php">
<span style="background:lightblue"><small>
Target:<input onkeyup="if(this.value!=validated(this.value))this.value=validated(this.value)" onchange="if(this.value!=validated(this.value))this.value=validated(this.value)" type="text" name="target" value="<?php echo $_GET['n'] ?>" />
<!--Delimiter:<select name="delim">
<option value="1">TAB</option>
<option value="2">;</option>
<option value="3">,</option>
<option value="4">","</option>
</select>
LF:<select name="delim">
<option value="1">\r\n</option>
<option value="2">\n</option>
</select>
-->
Headings:
<select name="h">
  <option value="0">select wisely</option>
  <option value="1">like target</option>
  <option value="2">1st row in my data</option>
</select>&nbsp;</span>
<span style="font-size:80%">Sys:
<select name="m" style="font-size:80%">
<option value="1">Notes and Authuser are fix values</option>
<option value="2">Notes = 1st column in my pasted data, Authuser fix</option>
<option value="3">Notes = 1st column in my pasted data, Authuser=2nd</option>
</select>
<select name="n" style="font-size:80%">
...
res=260;
function sizer() {
document.getElementById('csv').style.height=document.documentElement.clientHeight-res+'px';
setTimeout("sizer()",333);
}
sizer();
document.form.target.value=validated(document.form.target.value);
</script>
