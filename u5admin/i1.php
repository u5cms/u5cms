...
setcookie('subi', 'i1', time() + 3600 * 24 * 365 * 10, '/');
...
<table cellpadding="1">
    ...
    $sql_a = "SELECT * FROM resources WHERE (typ='$pidvesa' OR typ='a') AND name LIKE '" . mysql_real_escape_string(str_replace('*', '%', $_GET['f'])) . "' AND deleted=$delstatus ORDER by $orderby";
