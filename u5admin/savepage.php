...
$sql_a="INSERT INTO resources_log (name,ishomepage,content_d,content_e,content_f,title_d,title_e,title_f,desc_d,desc_e,desc_f,key_d,key_e,key_f,logins,hidden,operator,ip,lastmut,deleted,typ) VALUES 
(
'".mysql_real_escape_string($_POST['name'])."',
'".mysql_real_escape_string($_POST['ishomepage'])."',
'".mysql_real_escape_string($_POST['content_d'])."',
