...
?>
<h2>Invite a backend user (<?php if(!(isset($u5samlsalt)&&$u5samlsalt!='')){echo 'send password';}else{'<small><a href="javasript:void(0)" alert("The u5CMS installation at hand is federated via SAML with an external IAM system. Therefore, your target user must log in using an account from that IAM system that has exactly the email address you entered below as its email attribute.")>does NOT send a password. Read!</small></a>';} ?>)</h2>
