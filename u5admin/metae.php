...
?>
  ...
  <table id="lan3name" bgcolor="#FFFF99" width="100%">
    ...
    <table id="lan4name" bgcolor="#FFFF99" width="100%">
        <tr>
            <td>link-text*</td>
            <td width="99%"><input onchange="changes()" name="title_4" lang="<?php echo $lan4na ?>" type="text" id="t4" style="width:100%" value="<?php echo ehtml($row_a['title_4'])?>" /></td>
        </tr>
        <tr>
            <td>URL*</td>
            <td><input onchange="changes()" name="desc_4" lang="<?php echo $lan4na ?>" type="text" id="t5" style="width:100%" value="<?php echo ehtml($row_a['desc_4'])?>" /></td>
        </tr>
        <tr>
            <td>alt-text</td>
            <td><textarea onchange="changes()" name="content_4" lang="<?php echo $lan4na ?>" id="t6" style="width:100%" ><?php echo ehtml($row_a['content_4'])?></textarea></td>
        </tr>
    </table>
    ...
    <table id="lan5name" bgcolor="#FFFF99" width="100%">
        <tr>
            <td>link-text*</td>
            <td width="99%"><input onchange="changes()" name="title_5" lang="<?php echo $lan5na ?>" type="text" id="t4" style="width:100%" value="<?php echo ehtml($row_a['title_5'])?>" /></td>
        </tr>
        <tr>
            <td>URL*</td>
            <td><input onchange="changes()" name="desc_5" lang="<?php echo $lan5na ?>" type="text" id="t5" style="width:100%" value="<?php echo ehtml($row_a['desc_5'])?>" /></td>
        </tr>
        <tr>
            <td>alt-text</td>
            <td><textarea onchange="changes()" name="content_5" lang="<?php echo $lan5na ?>" id="t6" style="width:100%" ><?php echo ehtml($row_a['content_5'])?></textarea></td>
        </tr>
    </table>
  <p>
