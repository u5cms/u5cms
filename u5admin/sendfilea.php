...
<input onchange="parent.upstart();document.form1.submit();document.getElementById('spinner').style.display='inline'" name="userfile[]" type="file" size="80%" accept="image/jpeg,image/png" multiple />
