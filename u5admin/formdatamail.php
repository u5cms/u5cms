...
<select onchange="location.href='formdatamail.php?n=<?php echo $_GET['n']?>&s='+this.value+'&f='+escape(document.getElementById('filt').value)+'&o='+escape(getTransportText('u5_filt_o'))">
...
if (key==13){
if (document.getElementById('filt').value=='') document.getElementById('filt').value=getTransportText('u5_filt_o');location.href='formdatamail.php?n=<?php echo $_GET['n']?>&f='+escape(replace(replace(document.getElementById('filt').value,'"',''),'·',''))+'&s=<?php echo $_GET['s']?>';
}
}

function senden() {
if (document.getElementById('filt').value=='') document.getElementById('filt').value=getTransportText('u5_filt_o');location.href='formdatamail.php?n=<?php echo $_GET['n']?>&f='+escape(replace(replace(replace(document.getElementById('filt').value,'"',''),'·',''),'÷',''))+'&s=<?php echo $_GET['s']?>';
}
...
<script>
function unset() {
if (document.getElementById('filt').value=='') document.getElementById('filt').value=getTransportText('u5_filt_o');location.href='formdatamail.php?f=&n=<?php echo $_GET['n']?>&o='+escape(document.getElementById('filt').value)+'&s=<?php echo $_GET['s']?>';
}
