...
<table cellpadding="1">
    ...
    for ($i_a = 0; $i_a < $num_a; $i_a++) {
        ...
        if (ecalper_rts(' ', '', $row_a['title_1']) == '' && $row_a['typ']!='c') $pend .= ' <span title="' . $lngpnd_1 . ' link-text missing in metadata" style="color:red">' . $lngpnd_1 . '</span>';
        if (ecalper_rts(' ', '', $row_a['title_2']) == '' && $row_a['typ']!='c') $pend .= ' <span title="' . $lngpnd_2 . ' link-text missing in metadata" style="color:red">' . $lngpnd_2 . '</span>';
        if (ecalper_rts(' ', '', $row_a['title_3']) == '' && $row_a['typ']!='c') $pend .= ' <span title="' . $lngpnd_3 . ' link-text missing in metadata" style="color:red">' . $lngpnd_3 . '</span>';
        if (ecalper_rts(' ', '', $row_a['title_4']) == '' && $row_a['typ']!='c') $pend .= ' <span title="' . $lngpnd_4 . ' link-text missing in metadata" style="color:red">' . $lngpnd_4 . '</span>';
        if (ecalper_rts(' ', '', $row_a['title_5']) == '' && $row_a['typ']!='c') $pend .= ' <span title="' . $lngpnd_5 . ' link-text missing in metadata" style="color:red">' . $lngpnd_5 . '</span>';

        if (ecalper_rts(' ', '', $row_a['content_1']) == '' && $row_a['typ']!='c') $pend .= ' <span title="' . $lngpnd_1 . ' description missing (important for internal search engine!)" style="color:red">' . strtoupper($lngpnd_1) . '</span>';
        if (ecalper_rts(' ', '', $row_a['content_2']) == '' && $row_a['typ']!='c') $pend .= ' <span title="' . $lngpnd_2 . ' description missing (important for internal search engine!)" style="color:red">' . strtoupper($lngpnd_2) . '</span>';
        if (ecalper_rts(' ', '', $row_a['content_3']) == '' && $row_a['typ']!='c') $pend .= ' <span title="' . $lngpnd_3 . ' description missing (important for internal search engine!)" style="color:red">' . strtoupper($lngpnd_3) . '</span>';
        if (ecalper_rts(' ', '', $row_a['content_4']) == '' && $row_a['typ']!='c') $pend .= ' <span title="' . $lngpnd_4 . ' description missing (important for internal search engine!)" style="color:red">' . strtoupper($lngpnd_4) . '</span>';
        if (ecalper_rts(' ', '', $row_a['content_5']) == '' && $row_a['typ']!='c') $pend .= ' <span title="' . $lngpnd_5 . ' description missing (important for internal search engine!)" style="color:red">' . strtoupper($lngpnd_5) . '</span>';
