...
echo '
<table>
<tr><td><textarea readonly rows="2" id="t' . $i_a . 'a1">' . htmlXspecialchars($row_a['title_1']) . '</textarea></td><td><textarea readonly rows="2" id="t' . $i_a . 'a2">' . htmlXspecialchars($row_a['title_2']) . '</textarea></td><td><textarea readonly rows="2" id="t' . $i_a . 'a3">' . htmlXspecialchars($row_a['title_3']) . '</textarea></td><td><textarea readonly rows="2" id="t' . $i_a . 'a41">' . htmlXspecialchars($row_a['title_4']) . '</textarea></td><td><textarea readonly rows="2" id="t' . $i_a . 'a51">' . htmlXspecialchars($row_a['title_5']) . '</textarea></td></tr>
<tr style="display:none"><td><textarea readonly rows="2" id="t' . $i_a . 'a4">' . htmlXspecialchars($row_a['desc_1']) . '</textarea></td><td><textarea readonly rows="2" id="t' . $i_a . 'a5">' . htmlXspecialchars($row_a['desc_2']) . '</textarea></td><td><textarea readonly rows="2" id="t' . $i_a . 'a6">' . htmlXspecialchars($row_a['desc_3']) . '</textarea></td><td><textarea readonly rows="2" id="t' . $i_a . 'a42">' . htmlXspecialchars($row_a['desc_4']) . '</textarea></td><td><textarea readonly rows="2" id="t' . $i_a . 'a52">' . htmlXspecialchars($row_a['desc_5']) . '</textarea></td></tr>
<tr><td><textarea readonly rows="11" id="t' . $i_a . 'a7">' . htmlXspecialchars($row_a['content_1']) . '</textarea></td><td><textarea readonly rows="11" id="t' . $i_a . 'a8">' . htmlXspecialchars($row_a['content_2']) . '</textarea></td><td><textarea readonly rows="11" id="t' . $i_a . 'a9">' . htmlXspecialchars($row_a['content_3']) . '</textarea></td><td><textarea readonly rows="11" id="t' . $i_a . 'a43">' . htmlXspecialchars($row_a['content_4']) . '</textarea></td><td><textarea readonly rows="11" id="t' . $i_a . 'a53">' . htmlXspecialchars($row_a['content_5']) . '</textarea></td></tr>
</table>
';	
}
else {
echo '
<table>
<tr><td><textarea readonly rows="2" id="t' . $i_a . 'a1">' . ehtml($row_a['title_1']) . '</textarea></td><td><textarea readonly rows="2" id="t' . $i_a . 'a2">' . ehtml($row_a['title_2']) . '</textarea></td><td><textarea readonly rows="2" id="t' . $i_a . 'a3">' . ehtml($row_a['title_3']) . '</textarea></td><td><textarea readonly rows="2" id="t' . $i_a . 'a41">' . ehtml($row_a['title_4']) . '</textarea></td><td><textarea readonly rows="2" id="t' . $i_a . 'a51">' . ehtml($row_a['title_5']) . '</textarea></td></tr>
<tr style="display:none"><td><textarea readonly rows="2" id="t' . $i_a . 'a4">' . ehtml($row_a['desc_1']) . '</textarea></td><td><textarea readonly rows="2" id="t' . $i_a . 'a5">' . ehtml($row_a['desc_2']) . '</textarea></td><td><textarea readonly rows="2" id="t' . $i_a . 'a6">' . ehtml($row_a['desc_3']) . '</textarea></td><td><textarea readonly rows="2" id="t' . $i_a . 'a42">' . ehtml($row_a['desc_4']) . '</textarea></td><td><textarea readonly rows="2" id="t' . $i_a . 'a52">' . ehtml($row_a['desc_5']) . '</textarea></td></tr>
<tr><td><textarea readonly rows="11" id="t' . $i_a . 'a7">' . ehtml($row_a['content_1']) . '</textarea></td><td><textarea readonly rows="11" id="t' . $i_a . 'a8">' . ehtml($row_a['content_2']) . '</textarea></td><td><textarea readonly rows="11" id="t' . $i_a . 'a9">' . ehtml($row_a['content_3']) . '</textarea></td><td><textarea readonly rows="11" id="t' . $i_a . 'a43">' . ehtml($row_a['content_4']) . '</textarea></td><td><textarea readonly rows="11" id="t' . $i_a . 'a53">' . ehtml($row_a['content_5']) . '</textarea></td></tr>
</table>
';
}
}
