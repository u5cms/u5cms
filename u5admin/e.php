...
<table cellpadding="1">
    ...
    for ($i_a = 0; $i_a < $num_a; $i_a++) {
        ...
        if (str_replace(' ', '', $row_a['desc_d']) == '') $pend .= ' <span title="' . $lngpnd_d . ' URL missing in metadata" style="color:red">' . strtoupper($lngpnd_d) . '</span>';
        if (str_replace(' ', '', $row_a['desc_e']) == '') $pend .= ' <span title="' . $lngpnd_e . ' URL missing in metadata" style="color:red">' . strtoupper($lngpnd_e) . '</span>';
        if (str_replace(' ', '', $row_a['desc_f']) == '') $pend .= ' <span title="' . $lngpnd_f . ' URL missing in metadata" style="color:red">' . strtoupper($lngpnd_f) . '</span>';
