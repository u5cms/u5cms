...
<body>
<form onsubmit="cchanges=0;document.querySelectorAll('.asterisk').forEach(e=>e.classList.add('blink_me'));" action="meta2.php?typ=<?php echo $_GET['typ']?>&uri=metav.php" method="post" name="form1" id="form1">
  <p>
    <?php 
...
?>
  ...
  <table id="lan1name" bgcolor="#FFFF99" width="100%"><?php require('checktyp.inc.php'); ?>
    ...
    <tr>
      <td>(short&nbsp;caption)</td>
      <td><input onchange="changes()" name="desc_1" lang="<?php echo $lan1na ?>" type="text" style="width:98%" value="<?php echo ehtml($row_a['desc_1'])?>" /></td>
    </tr>
    <tr>
  ...
  <table id="lan2name" bgcolor="#FFFF99" width="100%">
    ...
    <tr>
      <td>(short&nbsp;caption)</td>
      <td><input onchange="changes()" name="desc_2" lang="<?php echo $lan2na ?>" type="text" style="width:98%" value="<?php echo ehtml($row_a['desc_2'])?>" /></td>
    </tr>
    <tr>
      <td>long&nbsp;caption<font color="#FF0000">*</font></td>
  ...
  <table id="lan3name" bgcolor="#FFFF99" width="100%">
    ...
    <tr>
      <td>(short&nbsp;caption)</td>
      <td><input onchange="changes()" name="desc_3" lang="<?php echo $lan3na ?>" type="text" style="width:98%" value="<?php echo ehtml($row_a['desc_3'])?>" /></td>
    </tr>
    <tr>
      <td>long&nbsp;caption<font color="#FF0000">*</font></td>
    ...
    <table id="lan4name" bgcolor="#FFFF99" width="100%">
        ...
        <tr>
            <td>(short&nbsp;caption)</td>
            <td><input onchange="changes()" name="desc_4" lang="<?php echo $lan4na ?>" type="text" style="width:98%" value="<?php echo ehtml($row_a['desc_4'])?>" /></td>
        </tr>
        <tr>
            <td>long&nbsp;caption<font color="#FF0000">*</font></td>
    ...
    <table id="lan5name" bgcolor="#FFFF99" width="100%">
        ...
        <tr>
            <td>(short&nbsp;caption)</td>
            <td><input onchange="changes()" name="desc_5" lang="<?php echo $lan5na ?>" type="text" style="width:98%" value="<?php echo ehtml($row_a['desc_5'])?>" /></td>
        </tr>
        <tr>
            <td>long&nbsp;caption<font color="#FF0000">*</font></td>
