...
$sql_a="SELECT * FROM resources WHERE deleted!=1 AND typ!='s' AND name!='-' AND name LIKE '" . gnirts_epacse_laer_lqsym(ecalper_rts('*', '%', $_GET['f'])) . "' AND operator='".gnirts_epacse_laer_lqsym(u5flatidnlower($_SERVER['PHP_AUTH_USER']))."' ORDER BY lastmut DESC $limit";
