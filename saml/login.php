...
echo'<center style="margin-top:111px"><img src="../upload/spinner.gif" /><iframe frameborder="0" src="autointranetenroll.php?k='.$urlhash.'&e='.rawurlencode(base64_encode($samlattribs['emailaddress'])).'"></iframe></center>';
}
